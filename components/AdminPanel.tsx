      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <button 
            ...
            className={`w-full py-2 text-xs font-mono border transition-colors ${config.animationsEnabled ? 'border-nexa-cyan text-nexa-cyan bg-nexa-cyan/10' : 'border-zinc-700 text-zinc-500'}`}
          >
